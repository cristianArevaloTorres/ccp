...
namespace DropBoxServiciosAccionesApi
{
    public class ServiciosAccionesApi
    {
        ...
        public ServiciosAccionesApi(string ApiKey = "epa71edcqqmt78k", string ApiSecret = "5i5mk4xig4r45mw", string ApplicationName = "democrat-axc")
        {
            try
            {
                AppKey = ApiKey;
        ...
        {
            var task = Task.Run((Func<Task>)ServiciosAccionesApi.Run);
            task.Wait();
        }
